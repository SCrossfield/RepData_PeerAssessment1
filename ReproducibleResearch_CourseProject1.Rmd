...
The mean and median number of steps taken per day are 10766.19 and `r median(myd$steps)` respectively.
...
```
The 5-minute interval with the maximum average number of steps is `r perInterval$interval[which.max(perInterval$steps)]`.
